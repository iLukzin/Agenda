...
function formVazio() { return { nome:'', cnpj:'', email:'', telefone:'', endereco:'', plano:'profissional', status:'ativo', vencimento:'', bloqueada: false, motivo_bloqueio:'', whatsapp_habilitado: false, financeiro_habilitado: false, auto_agenda_habilitado: false, valor_mensal:'', dia_vencimento:'' } }
